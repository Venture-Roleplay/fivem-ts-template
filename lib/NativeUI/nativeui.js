...
!(function (e) {
    (e[(e.NextCamera = 0)] = "NextCamera"),
        ...
        (e[(e.VehicleMouseControlOverride = 106)] =
        ...
        (e[(e.VehicleFlySelectNextWeapon = 115)] =
            "VehicleFlySelectNextWeapon"),
        (e[(e.VehicleFlySelectPrevWeapon = 116)] =
            "VehicleFlySelectPrevWeapon"),
        (e[(e.VehicleFlySelectTargetLeft = 117)] =
            "VehicleFlySelectTargetLeft"),
        (e[(e.VehicleFlySelectTargetRight = 118)] =
        ...
        (e[(e.SelectCharacterMultiplayer = 169)] =
        ...
        (e[(e.FrontendSocialClubSecondary = 213)] =
        ...
        (e[(e.ReplayTimelineDuplicateClip = 324)] =
...
!(function (e) {
    (e[(e.HUD_COLOUR_PURE_WHITE = 0)] = "HUD_COLOUR_PURE_WHITE"),
        ...
        (e[(e.HUD_COLOUR_MENU_YELLOW_DARK = 65)] =
        ...
        (e[(e.HUD_COLOUR_MENU_EXTRA_DIMMED = 72)] =
        ...
        (e[(e.HUD_COLOUR_NET_PLAYER1_DARK = 75)] =
            "HUD_COLOUR_NET_PLAYER1_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER2_DARK = 76)] =
            "HUD_COLOUR_NET_PLAYER2_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER3_DARK = 77)] =
            "HUD_COLOUR_NET_PLAYER3_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER4_DARK = 78)] =
            "HUD_COLOUR_NET_PLAYER4_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER5_DARK = 79)] =
            "HUD_COLOUR_NET_PLAYER5_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER6_DARK = 80)] =
            "HUD_COLOUR_NET_PLAYER6_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER7_DARK = 81)] =
            "HUD_COLOUR_NET_PLAYER7_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER8_DARK = 82)] =
            "HUD_COLOUR_NET_PLAYER8_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER9_DARK = 83)] =
            "HUD_COLOUR_NET_PLAYER9_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER10_DARK = 84)] =
            "HUD_COLOUR_NET_PLAYER10_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER11_DARK = 85)] =
            "HUD_COLOUR_NET_PLAYER11_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER12_DARK = 86)] =
            "HUD_COLOUR_NET_PLAYER12_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER13_DARK = 87)] =
            "HUD_COLOUR_NET_PLAYER13_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER14_DARK = 88)] =
            "HUD_COLOUR_NET_PLAYER14_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER15_DARK = 89)] =
            "HUD_COLOUR_NET_PLAYER15_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER16_DARK = 90)] =
            "HUD_COLOUR_NET_PLAYER16_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER17_DARK = 91)] =
            "HUD_COLOUR_NET_PLAYER17_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER18_DARK = 92)] =
            "HUD_COLOUR_NET_PLAYER18_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER19_DARK = 93)] =
            "HUD_COLOUR_NET_PLAYER19_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER20_DARK = 94)] =
            "HUD_COLOUR_NET_PLAYER20_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER21_DARK = 95)] =
            "HUD_COLOUR_NET_PLAYER21_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER22_DARK = 96)] =
            "HUD_COLOUR_NET_PLAYER22_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER23_DARK = 97)] =
            "HUD_COLOUR_NET_PLAYER23_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER24_DARK = 98)] =
            "HUD_COLOUR_NET_PLAYER24_DARK"),
        (e[(e.HUD_COLOUR_NET_PLAYER25_DARK = 99)] =
        ...
        (e[(e.HUD_COLOUR_INACTIVE_MISSION = 124)] =
        ...
        (e[(e.HUD_COLOUR_SCRIPT_VARIABLE = 128)] =
        ...
        (e[(e.HUD_COLOUR_OBJECTIVE_ROUTE = 156)] =
        ...
        (e[(e.HUD_COLOUR_CONTROLLER_CHOP = 174)] =
...
(O.Empty = new O(0, 0, 0, 0)),
    (O.Transparent = new O(0, 0, 0, 0)),
    (O.Black = new O(0, 0, 0, 255)),
    (O.White = new O(255, 255, 255, 255)),
    (O.WhiteSmoke = new O(245, 245, 245, 255));
class R {
    constructor(e = 0, t = 0) {
...
class L extends d {
    constructor(e, t, i, s, n, h) {
        super(),
            ...
            (this.Pos = t),
            (this.Scale = i),
            (this.Color = s || new O(255, 255, 255, 255)),
            (this.Font = n || 0),
            (this.Centered = h || !1);
    }
    Draw(e, t, i, s, n, h) {
        ...
        const o = t.X / 1280,
            r = t.Y / 720;
        SetTextFont(parseInt(n)),
            SetTextScale(i, i),
            SetTextColour(s.R, s.G, s.B, s.A),
            SetTextCentre(h),
            BeginTextCommandDisplayText("STRING"),
            L.AddLongString(e),
            EndTextCommandDisplayText(o, r);
    }
    static AddLongString(e) {
        ...
        for (let t, i = 0; i < e.length; i += 99) {
            ...
            (s.match(/~/g) || []).length % 2 != 0
                ...
                AddTextComponentSubstringPlayerName(e.substr(n, t));
        }
    }
}
const U = GetActiveScreenResolution();
class C {
    static get ResolutionMaintainRatio() {
        const e = C.Width / C.Height;
        return new R(1080 * e, 1080);
    }
    static MousePosition(e = !1) {
        const t = C.ResolutionMaintainRatio;
        let [i, s] = GetNuiCursorPosition();
        return e && ([i, s] = [i / t.Width, s / t.Height]), { X: i, Y: s };
    }
    static IsMouseInBounds(e, t) {
        const i = C.MousePosition();
        return (
            i.X >= e.X &&
            i.X <= e.X + t.Width &&
            i.Y > e.Y &&
    ...
    static GetTextWidth(e, t, i) {
        BeginTextCommandWidth("CELL_EMAIL_BCON"),
            ...
            SetTextFont(t),
            SetTextScale(1, i);
        const s = EndTextCommandGetWidth(!0);
        return C.ResolutionMaintainRatio.Width * s;
    }
    static GetLineCount(e, t, i, s, n) {
        BeginTextCommandLineCount("CELL_EMAIL_BCON"), L.AddLongString(e);
        const h = C.ResolutionMaintainRatio,
            o = t.X / h.Width,
            r = t.Y / h.Height;
        if ((SetTextFont(i), SetTextScale(1, s), n > 0)) {
            const e = t.X / h.Width + n / h.Width;
            SetTextWrap(o, e);
        }
        return EndTextCommandGetLineCount(o, r);
    }
}
(C.Width = U[0]), (C.Height = U[1]);
class D {
    constructor(e, t, i, s, n = 0, h = new O(255, 255, 255)) {
        (this.TextureDict = e),
            (this.TextureName = t),
            (this.Pos = i),
            (this.Size = s),
    ...
    requestTextureDictPromise(e) {
        return new Promise((t, i) => {
            RequestStreamedTextureDict(e, !0);
            let s = setInterval(() => {
                if (HasStreamedTextureDictLoaded(e))
                    return clearInterval(s), t(!0);
            }, 10);
        });
    }
    set TextureDict(e) {
        ...
        (e = e || this.TextureDict),
            ...
            (o = o || !0) &&
                (HasStreamedTextureDictLoaded(e) ||
                    RequestStreamedTextureDict(e, !0));
        const r = 1080 * (C.Width / C.Height),
            a = this.Size.Width / r,
            l = this.Size.Height / 1080,
            _ = this.Pos.X / r + 0.5 * a,
            c = this.Pos.Y / 1080 + 0.5 * l;
        DrawSprite(e, t, _, c, a, l, n, h.R, h.G, h.B, h.A);
    }
}
class m extends d {
    constructor(e, t, i) {
    ...
    Draw(e, t, i) {
        ...
        const s = t.Width / 1280,
            ...
            h = e.X / 1280 + 0.5 * s,
            o = e.Y / 720 + 0.5 * n;
        DrawRect(h, o, s, n, i.R, i.G, i.B, i.A);
    }
}
class S extends m {
    constructor(e, t, i) {
    ...
    Draw(e, t, i) {
        e || (e = new R()),
            !e ||
                ...
                (t = this.Size),
                (i = this.Color));
        const s = 1080 * (C.Width / C.Height),
            n = t.Width / s,
            h = t.Height / 1080,
            o = e.X / s + 0.5 * n,
            r = e.Y / 1080 + 0.5 * h;
        DrawRect(o, r, n, h, i.R, i.G, i.B, i.A);
    }
}
class p extends L {
    constructor(e, t, i, s, n, h) {
        super(e, t, i, s || new O(255, 255, 255), n || 0, !1),
            (this.TextAlignment = o.Left),
            (this.Wrap = 0),
            h && (this.TextAlignment = h);
    }
    get WordWrap() {
        return new R(this.Wrap, 0);
    }
    set WordWrap(e) {
        this.Wrap = e.Width;
    }
    Draw(e, t, i, s, n, h, r, a, l) {
        let _ = e,
            c = h,
            O = h;
        e || (e = new R(0, 0)),
        ...
        if (
            ...
            switch ((r && SetTextDropshadow(2, 0, 0, 0, 0), O)) {
                case o.Centered:
                    SetTextCentre(!0);
                    break;
                case o.Right:
                    SetTextRightJustify(!0), SetTextWrap(0, U);
            }
            if (this.Wrap) {
                const e = (this.Pos.X + this.Wrap) / d;
                SetTextWrap(U, e);
            }
        }
        BeginTextCommandDisplayText("CELL_EMAIL_BCON"),
            L.AddLongString(_),
            EndTextCommandDisplayText(U, D);
    }
}
function f() {
    let e,
...
class T {
    constructor(e, t = "", s = null) {
        (this.Id = f()),
            (this.BackColor = T.DefaultBackColor),
            (this.HighlightedBackColor = T.DefaultHighlightedBackColor),
            (this.ForeColor = T.DefaultForeColor),
            (this.HighlightedForeColor = T.DefaultHighlightedForeColor),
            (this.RightLabel = ""),
            (this.LeftBadge = i.None),
            (this.RightBadge = i.None),
            (this.Enabled = !0),
            (this.Data = s),
            (this._rectangle = new S(
                new u(0, 0),
                new R(431, 38),
                new O(150, 0, 0, 0)
            )),
            ...
            (this.Description = t),
            (this._selectedSprite = new D(
                "commonmenu",
                "gradient_nav",
                new u(0, 0),
                new R(431, 38)
            )),
            (this._badgeLeft = new D(
                "commonmenu",
                "",
                new u(0, 0),
                new R(40, 40)
            )),
            (this._badgeRight = new D(
                "commonmenu",
                "",
                new u(0, 0),
                new R(40, 40)
    ...
    Draw() {
        (this._rectangle.Size = new R(431 + this.Parent.WidthOffset, 38)),
            (this._selectedSprite.Size = new R(
                431 + this.Parent.WidthOffset,
                38
            )),
            this.Hovered &&
                !this.Selected &&
                ((this._rectangle.Color = new O(255, 255, 255, 20)),
    ...
    BadgeToColor(e, t) {
        switch (e) {
            ...
            case i.Tick:
            case i.Crown:
                return t ? new O(255, 0, 0, 0) : new O(255, 255, 255, 255);
            default:
                return new O(255, 255, 255, 255);
        }
    }
}
(T.DefaultBackColor = O.Empty),
    (T.DefaultHighlightedBackColor = O.White),
    (T.DefaultForeColor = O.WhiteSmoke),
    (T.DefaultHighlightedForeColor = O.Black);
class I extends T {
    constructor(e, t = !1, i = "") {
        super(e, i), (this.Checked = !1);
        (this._checkedSprite = new D(
            "commonmenu",
            "shop_box_blank",
            new u(410, 95),
            new R(50, 50)
    ...
    Draw() {
        ...
        const e = this.HighlightedForeColor == T.DefaultHighlightedForeColor;
        this.Selected && e
...
class E {
    constructor(e = "", t = null) {
        (this.Id = f()), (this.DisplayText = e), (this.Data = t);
    }
}
class g {
    constructor(e) {
    ...
    getListItems() {
        ...
        for (const t of this.items)
            t instanceof E
                ...
                : "string" == typeof t
                ? e.push(new E(t))
                : "number" == typeof t && e.push(new E(t.toString()));
        return e;
    }
}
class A extends T {
    constructor(e, t = "", i = new g([]), s = 0, h = null) {
        super(e, t, h),
        ...
        (this.Collection = i.getListItems()),
            (this.Index = s),
            (this._arrowLeft = new D(
                "commonmenu",
                "arrowleft",
                new u(110, 105),
                new R(30, 30)
            )),
            (this._arrowRight = new D(
                "commonmenu",
                "arrowright",
                new u(280, 105),
                new R(30, 30)
    ...
    set Index(e) {
        ...
        const t =
            this.Collection.length >= this.Index
                ...
                : " ";
        this._currentOffset = C.GetTextWidth(
            t,
...
class P extends T {
    constructor(e, t = "", i = 0, s = 10, h = 0, r = null) {
        super(e, t, r),
            (this._currentOffset = 0),
        ...
        (this.LowerThreshold = i),
            ...
            (this.SelectedValue = h < i || h > s ? i : h),
            (this._arrowLeft = new D(
                "commonmenu",
                "arrowleft",
                new u(110, 105),
    ...
    set SelectedValue(e) {
        if (e < this._lowerThreshold || e > this._upperThreshold)
            throw new Error(
                "The value can not be outside the lower or upper limits"
            );
        var t;
        (this._selectedValue =
            ...
            (this._currentOffset = C.GetTextWidth(
                this.PreCaptionText +
                    ...
                    this.PostCaptionText,
                this._itemText && this._itemText.Font ? this._itemText.Font : 0,
                this._itemText && this._itemText.Scale
...
class w extends T {
    constructor(e, t, i, s = "", n = !1, h = null) {
        ...
        (this._items = t),
            ...
            (this._rectangleBackground = new S(
                new u(0, 0),
                new R(150, 9),
                new O(4, 32, 57, 255)
            )),
            (this._rectangleSlider = new S(
                new u(0, 0),
                new R(75, 9),
                new O(57, 116, 200, 255)
            )),
            (this._rectangleDivider = new S(
                new u(0, 0),
                new R(2.5, 20),
                n ? O.WhiteSmoke : O.Transparent
            )),
            (this.Index = i);
    }
    get Index() {
...
class H extends m {
    ...
    Draw(e) {
        ...
        this.Items))
            o.Draw(new R(this.Pos.X + e.Width, this.Pos.Y + e.Height));
    }
}
class M {
    static PlaySound(e, t) {
        PlaySound(-1, e, t, !1, 0, !0);
    }
}
class x {
    constructor() {
...
class N {
    ...
    GetButtonId() {
        return this._usingControls
            ? GetControlInstructionalButton(2, this._buttonControl, 0)
...
class V {
    ...
    get isLoaded() {
        return 1 === HasScaleformMovieLoaded(this._handle);
    }
    callFunctionHead(e, ...t) {
        this.isValid &&
            this.isLoaded &&
            (BeginScaleformMovieMethod(this._handle, e),
            t.forEach((e) => {
                switch (typeof e) {
                    case "number":
                        Number(e) === e && e % 1 != 0
    ...
    callFunction(e, ...t) {
        this.callFunctionHead(e, ...t), EndScaleformMovieMethod();
    }
    callFunctionReturn(e, ...t) {
        return (
            this.callFunctionHead(e, ...t), EndScaleformMovieMethodReturnValue()
        );
    }
    render2D() {
        this.isValid &&
...
class y {
    static Initialize(e, t) {
        (this._transitionOutAnimName = t), (this._scaleform = new V(e));
    }
...
(y._messageVisible = !1),
    (y._transitionOutTimeout = null),
    (y._transitionOutFinishedTimeout = null),
    (y._delayedTransitionInTimeout = null),
    (y._scaleform = null),
    (y._transitionOutTimeMs = 500),
    (y._transitionOutAnimName = null);
class F extends y {
    static Initialize(e, t) {
        super.Initialize(e, t), setTick(() => this.Render());
    }
...
F.Initialize("MP_BIG_MESSAGE_FREEMODE", "TRANSITION_OUT");
class b extends y {
    static Initialize(e, t) {
        super.Initialize(e, t), setTick(() => this.Render());
    }
...
b.Initialize("MIDSIZED_MESSAGE", "SHARD_ANIM_OUT");
class Y extends T {
    constructor(e, t, i = "", s = null, h = null) {
        super(e, i, h),
            (this._currentOffset = 0),
            (this._precaptionText = ""),
    ...
    set SelectedValue(e) {
        (this._selectedValue = e),
            null != e &&
                (this._currentOffset = C.GetTextWidth(
                    this.PreCaptionText + this._selectedValue,
                    this._itemText && this._itemText.Font
                        ? this._itemText.Font
                        : 0,
                    this._itemText && this._itemText.Scale
                        ? this._itemText.Scale
...
class v {
    constructor(e, t, i, s, h) {
        (this._visible = !0),
            ...
            (this._safezoneOffset = new u(0, 0)),
            ...
            (this.MenuItems = []),
            (this.IndexChange = new x()),
            (this.ListChange = new x()),
            (this.AutoListChange = new x()),
            (this.DynamicListChange = new x()),
            (this.SliderChange = new x()),
            (this.CheckboxChange = new x()),
            (this.ItemSelect = new x()),
            (this.MenuOpen = new x()),
            (this.MenuClose = new x()),
            (this.MenuChange = new x()),
            i instanceof u || (i = u.Parse(i)),
            (this._spriteLibrary = s || "commonmenu"),
            (this._spriteName = h || "interaction_bgd"),
            (this._offset = new u(i.X, i.Y)),
            (this.Children = new Map()),
            (this._instructionalButtonsScaleform = new V(
                "instructional_buttons"
            )),
            this.UpdateScaleform(),
            (this._mainMenu = new H(
                new u(0, 0),
                new R(700, 500),
                new O(0, 0, 0, 0)
            )),
            (this._bannerSprite = new D(
                this._spriteLibrary,
                this._spriteName,
                new u(0 + this._offset.X, 0 + this._offset.Y),
                new R(431, 107)
            )),
            this._mainMenu.addItem(
                (this._titleResText = new p(
                    e,
                    new u(215 + this._offset.X, 20 + this._offset.Y),
            ...
            "" !== t &&
                (this._mainMenu.addItem(
                    new S(
                        new u(0 + this._offset.X, 107 + this._offset.Y),
                        new R(431, 37),
                        new O(0, 0, 0, 255)
                    )
                ),
                this._mainMenu.addItem(
                    (this._subtitleResText = new p(
                        t,
                        new u(8 + this._offset.X, 110 + this._offset.Y),
                        0.35,
                        new O(255, 255, 255),
                        0,
                        o.Left
                ...
                (this._counterText = new p(
                    "",
                    new u(425 + this._offset.X, 110 + this._offset.Y),
                    0.35,
                    new O(255, 255, 255),
                    0,
                    o.Right
            ...
            (this._extraRectangleDown = new S(
                new u(
                    0 + this._offset.X,
                    162 +
                        38 * (this._maxItemsOnScreen + 1) +
            ...
            (this._descriptionBar = new S(
                new u(this._offset.X, 123),
                new R(431, 4),
                O.Black
            )),
            (this._descriptionRectangle = new D(
                "commonmenu",
                "gradient_bgd",
                new u(this._offset.X, 127),
                new R(431, 30)
            )),
            ...
            (this._background = new D(
                ...
                new u(
                    this._offset.X,
                    144 + this._offset.Y - 37 + this._extraOffset
                ),
                new R(290, 25)
            )),
            (this._visible = !1),
    ...
    set Visible(e) {
        if (
            ((this._visible = e),
            // M.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY),
            this.UpdateScaleform(),
            ...
            if (e) {
                if (
                    ...
                    const e = W.length ? W[W.length - 1] : null;
                    W.push(this),
                        e !== this._poolOpening &&
                            null !== e &&
                ...
                null === this.ParentMenu &&
                    ...
                    (W[W.length - 1] === this &&
                        ...
                        W.length || (this._poolOpening = null)),
                    W.length &&
                        ((this._poolOpening = W[W.length - 1]),
                        (W[W.length - 1].Visible = !0))),
                    0 === W.length && SetMouseCursorSprite(1);
            }
        ...
        (this.MenuItems[this._activeItem % this.MenuItems.length].Selected =
            ...
            this.CurrentSelection > this._maxItem
                ? ((this._maxItem = this.CurrentSelection),
                  (this._minItem =
                      this.CurrentSelection - this._maxItemsOnScreen))
                : this.CurrentSelection < this._minItem &&
                  ((this._maxItem =
                      this._maxItemsOnScreen + this.CurrentSelection),
    ...
    SetRectangleBannerType(e) {
        (this._bannerSprite = null),
            ...
            (this._bannerRectangle.Pos = new u(this._offset.X, this._offset.Y)),
            (this._bannerRectangle.Size = new R(431 + this.WidthOffset, 107));
    }
    AddSpriteBannerType(e) {
        (this._bannerSprite = e),
            (this._bannerSprite.Size = new R(431 + this.WidthOffset, 107)),
            (this._bannerSprite.Pos = new u(this._offset.X, this._offset.Y));
    }
    SetNoBannerType() {
        (this._bannerSprite = null),
            (this._bannerRectangle = new S(
                new u(this._offset.X, this._offset.Y),
                new R(431 + this.WidthOffset, 107),
                new O(0, 0, 0, 0)
            ));
    }
    ...
    RecalculateDescriptionPosition() {
        ...
        (this._descriptionBar.Size = new R(431 + this.WidthOffset, 4)),
            (this._descriptionRectangle.Size = new R(
    ...
    SetMenuWidthOffset(e) {
        if (
            ...
            this._mainMenu.Items[1].size = new R(431 + this.WidthOffset, 37);
        }
    ...
    CleanUp(e = !1) {
        e &&
            ...
            this.MenuItems.filter((e) => e instanceof Y).forEach((e) => {
    ...
    GoLeft() {
        if (
            (this.MenuItems[this.CurrentSelection] instanceof A ||
                this.MenuItems[this.CurrentSelection] instanceof P ||
                this.MenuItems[this.CurrentSelection] instanceof Y ||
                this.MenuItems[this.CurrentSelection] instanceof w) &&
            this.MenuItems[this.CurrentSelection].Enabled
        )
            if (this.MenuItems[this.CurrentSelection] instanceof A) {
                const e = this.MenuItems[this.CurrentSelection];
                if (0 == e.Collection.length) return;
                e.Index--,
                    // M.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.ListChange.emit(e, e.Index),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof P) {
                const e = this.MenuItems[this.CurrentSelection];
                e.SelectedValue <= e.LowerThreshold
                    ? (e.SelectedValue = e.UpperThreshold)
                    : (e.SelectedValue -= e.LeftMoveThreshold),
                    // M.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.AutoListChange.emit(e, e.SelectedValue, c.Left),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof Y) {
                const e = this.MenuItems[this.CurrentSelection];
                e
                    .SelectionChangeHandlerPromise(e, e.SelectedValue, c.Left)
                    .then((t) => {
                        (e.SelectedValue = t),
                            this.DynamicListChange.emit(
                                e,
                                e.SelectedValue,
                                c.Left
                            );
                    ...
                    // M.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof w) {
                const e = this.MenuItems[this.CurrentSelection];
                (e.Index = e.Index - 1),
                    // M.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
        ...
        if (
            ...
            if (this.MenuItems[this.CurrentSelection] instanceof A) {
                ...
                e.SelectedValue >= e.UpperThreshold
                    ...
                    // M.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
                    this.AutoListChange.emit(e, e.SelectedValue, c.Right),
                    this.UpdateDescriptionCaption();
            } else if (this.MenuItems[this.CurrentSelection] instanceof Y) {
                const e = this.MenuItems[this.CurrentSelection];
                e
                    .SelectionChangeHandlerPromise(e, e.SelectedValue, c.Right)
                    .then((t) => {
                        (e.SelectedValue = t),
                            this.DynamicListChange.emit(
                                e,
    ...
    SelectItem() {
        if (!this.MenuItems[this.CurrentSelection].Enabled)
            return void M.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY);
        const e = this.MenuItems[this.CurrentSelection];
        if (this.MenuItems[this.CurrentSelection] instanceof I)
            (e.Checked = !e.Checked),
                // M.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY),
    ...
    HasCurrentSelectionChildren() {
        const e = this.MenuItems[this.CurrentSelection];
        return !!(
            this.MenuItems[this.CurrentSelection] instanceof T &&
            this.Children.has(e.Id)
        );
    }
    IsMouseInListItemArrows(e, t, i) {
        ...
        let s = C.ResolutionMaintainRatio;
        let n = 1080 * (s.Width / s.Height);
        const h = 5 + EndTextCommandGetWidth(!1) * n * 0.35 + 10,
            o = 431 - h;
        return C.IsMouseInBounds(t, new R(h, 38))
            ? 1
            : C.IsMouseInBounds(new u(t.X + h, t.Y), new R(o, 38))
            ? 2
            : 0;
    }
    ProcessMouse() {
        ...
        this.MenuItems.length > this._maxItemsOnScreen + 1 &&
            (e = this._maxItem),
            C.IsMouseInBounds(new u(0, 0), new R(30, 1080)) &&
            this._mouseEdgeEnabled
                ? (SetGameplayCamRelativeHeading(
                      GetGameplayCamRelativeHeading() + 5
                  ),
                  SetMouseCursorSprite(6))
                : C.IsMouseInBounds(
                      new u(C.ResolutionMaintainRatio.Width - 30, 0),
                      new R(30, 1080)
                  ) && this._mouseEdgeEnabled
                ? (SetGameplayCamRelativeHeading(
                      GetGameplayCamRelativeHeading() - 5
                ...
                : this._mouseEdgeEnabled && SetMouseCursorSprite(1);
        for (let i = this._minItem; i <= e; i++) {
            ...
            const h = 38,
                o = this.MenuItems[i];
            if (C.IsMouseInBounds(new u(e, s), new R(n, h))) {
                o.Hovered = !0;
                ...
                if (
                    (o.Hovered &&
                        1 == t &&
                        (this.MenuItems[i] instanceof A ||
                            this.MenuItems[i] instanceof P ||
                            this.MenuItems[i] instanceof Y) &&
                        SetMouseCursorSprite(5),
                    IsControlJustReleased(0, 65) ||
                        IsDisabledControlJustReleased(0, 65))
                )
                    if (o.Selected && o.Enabled)
                        ...
                        o.Selected
                            ? !o.Enabled &&
                              o.Selected &&
                              M.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY)
        ...
        this.MenuItems.length <= this._maxItemsOnScreen + 1 ||
            (C.IsMouseInBounds(new u(s, i), new R(431 + this.WidthOffset, 18))
                ? ((this._extraRectangleUp.Color = new O(30, 30, 30, 255)),
                  (IsControlJustPressed(0, 65) ||
                      IsDisabledControlJustPressed(0, 65)) &&
                      (this.MenuItems.length > this._maxItemsOnScreen + 1
                          ? this.GoUpOverflow()
                          : this.GoUp()))
                : (this._extraRectangleUp.Color = new O(0, 0, 0, 200)),
            C.IsMouseInBounds(
                new u(s, i + 18),
                new R(431 + this.WidthOffset, 18)
            )
                ? ((this._extraRectangleDown.Color = new O(30, 30, 30, 255)),
                  (IsControlJustPressed(0, 65) ||
                      IsDisabledControlJustPressed(0, 65)) &&
                      (this.MenuItems.length > this._maxItemsOnScreen + 1
                          ? this.GoDownOverflow()
                          : this.GoDown()))
                : (this._extraRectangleDown.Color = new O(0, 0, 0, 200)));
    }
    ProcessControl() {
        this.Visible &&
            (this._justOpened
                ? (this._justOpened = !1)
                : (IsControlJustReleased(0, 65) && this.GoBack(),
                  0 != this.MenuItems.length &&
                      (IsControlPressed(0, 65) &&
    ...
    GoUpOverflow() {
        this.MenuItems.length <= this._maxItemsOnScreen + 1 ||
            ...
            // M.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY),
            this.IndexChange.emit(
                this.CurrentSelection,
                this.MenuItems[this._activeItem % this.MenuItems.length]
            ),
    ...
    UpdateScaleform() {
        ...
        this._instructionalButtonsScaleform.callFunction("CLEAR_ALL"),
            ...
            this._instructionalButtonsScaleform.callFunction(
                "SET_DATA_SLOT",
                0,
                GetControlInstructionalButton(2, a.PhoneSelect, 0),
                this.SelectTextLocalized
            ),
            this._instructionalButtonsScaleform.callFunction(
                "SET_DATA_SLOT",
                1,
                GetControlInstructionalButton(2, a.PhoneCancel, 0),
    ...
    render() {
        ...
        if (this.MenuItems.length <= this._maxItemsOnScreen + 1) {
            for (const t of this.MenuItems)
                t.SetVerticalPosition(38 * e - 37 + this._extraOffset),
                    t.Draw(),
                    e++;
            this._counterText &&
            ...
            for (let t = this._minItem; t <= this._maxItem; t++) {
                ...
                i.SetVerticalPosition(38 * e - 37 + this._extraOffset),
                    i.Draw(),
                    e++;
            }
            if (
                ((this._extraRectangleUp.Size = new R(
                    431 + this.WidthOffset,
                    18
                )),
                (this._extraRectangleDown.Size = new R(
                    431 + this.WidthOffset,
                    18
                )),
...
export {
    ...
    i as BadgeStyle,
    F as BigMessage,
    c as ChangeDirection,
    O as Color,
    a as Control,
    n as Font,
    _ as HudColor,
    N as InstructionalButton,
    g as ItemsCollection,
    E as ListItem,
    v as Menu,
    b as MidsizedMessage,
    u as Point,
    S as ResRectangle,
    R as Size,
    D as Sprite,
    P as UIMenuAutoListItem,
    I as UIMenuCheckboxItem,
    Y as UIMenuDynamicListItem,
    T as UIMenuItem,
    A as UIMenuListItem,
    w as UIMenuSliderItem,
};
